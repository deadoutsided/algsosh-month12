...
Стили, компоненты предоставлены платформой, сам проект заключался в написании реализаций алгоритмов и структур данных, их визуализация при помощи предоставленных компонентов и написание тестирования приложения.
Тестирование в проекте:
- Unit тесты описаны при помощи jest, react-testing-library
- Для написания E2E тестов применялась cypress
<details>
  <summary>Содержание задания и пояснение к конкретным структурам/алгоритмам</summary>
